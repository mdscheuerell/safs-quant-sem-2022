...
$\lambda_{\mathbf{B}}$ denotes the eigenvalues of $\mathbf{B}$

Return from $\boldsymbol{\mu}_t \rightarrow \boldsymbol{\mu}_{\infty}$ is given by $\max(\lambda_{\mathbf{B}})$
...
Return from $\boldsymbol{\Sigma}_t \rightarrow \boldsymbol{\Sigma}_{\infty}$ is given by $\max(\lambda_{\mathbf{B} \otimes \mathbf{B}})$
