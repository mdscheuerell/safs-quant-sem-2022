...
```{r ex_reactivity, align.fig="center", fig.dim=c(7,4)}
...
.blue-text[
### Consider a small perturbation to $\mathbf{x}_{t-1}$ by the vector $\boldsymbol{\delta}$, which we can write as
]
...
.blue-text[
### The combined effects of species interactions relative to environmental (process) noise
]
