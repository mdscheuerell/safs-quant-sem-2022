...
If $\lambda_{\mathbf{B}}$ denotes the eigenvalues of $\mathbf{B}$

Rate of return from $\boldsymbol{\mu}_t \rightarrow \boldsymbol{\mu}_{\infty}$ is given by $\max(\lambda_{\mathbf{B}})$
