...
.blue-text[
### When $|b| < 1$, the equilibrium for an AR(1) process is called<br>the _stationary distribution_
]
...
$$\mu_{\infty} = \frac{r_{\max}}{1 - b} ~~ \rightarrow ~~ \mu_t = \mu_{\infty} + b^t(x_0 - \mu_{\infty})\\
~ \\
\sigma_{\infty} = \frac{q}{1 - b^2} ~~ \rightarrow ~~ \sigma_t = \sigma_{\infty}[1 - (b^2)^t]$$
