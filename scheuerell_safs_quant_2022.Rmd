...
.blue-text[
### Now let's consider the proportion $\pi$ of the stationary variance owing to density dependence
]
...
### Specifically, the size of a scalar is just the value itself, but we need a way to meassure the "volume" of the matrices
]
...
0 & 0 & 2
\end{bmatrix} 
  &= 2(2 \cdot 2 - 0 \cdot 0) - 0(0 \cdot 0 - 0 \cdot 2) + 0(0 \cdot 0 - 2 \cdot 0) \\
  &= 2(4 - 0) - 0(0 - 0) + 0(0 - 0) \\
  &= 8
\end{align}$$
