...
.citation-gray-text[Ives et al (2003) _Ecology_]
...
.citation-gray-text[Neubert et al (2009) _Ecology_]
...
.blue-text[
### In many cases, we are interested in the change in $\pi_{\mathbf{B}}$ with respect to the $(i,j)$ element of $\mathbf{B}$, which is given by
]
...
.citation.gray-text[Hampton, Scheuerell & Schindler (2006) _L&O_]
