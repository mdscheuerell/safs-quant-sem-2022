...
.blue-text[
### In stochastic models, the equilibria is a _stationary distribution_
]
...
# Rate of convergence for multivariate models

.blue-text[
### For multivariate models, convergence is governed by the interaction matrix $\mathbf{B}$
]
...
.blue-text[
### Rate of return for the mean $\mathbf{x}_t$
]

$$\boldsymbol{\mu}_t \rightarrow \boldsymbol{\mu}_{\infty}: \max(\lambda_{\mathbf{B}})$$
...
.blue-text[
### Rate of return for the covariance $\mathbf{x}_t$
]
